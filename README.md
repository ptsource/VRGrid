...
# PTSource VRGrid
### Current version 10 released 21/06/2020 for Windows

PTSource VRGrid is a free standard based desktop application for Windows x32 and x64 for representing interactive 3D and 2D with VR support inside a cuboid engine. It includes its own scripting language for software design, and a format support for 3D models. The design goals its to emphasize simplicity, generality, and usability.
